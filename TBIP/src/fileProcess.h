...
void getRoadforPartitionOnDensity(vector<Edge> edges, map<int, double> edge_density_map, map<string, double> edge_pro_map,
		string output_road_for_partition);
void outputEdgesPartition(int partitionNum, string input_edge_partition, string output_partition);
